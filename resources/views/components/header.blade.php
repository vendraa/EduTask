...
>
  ...
  >
    ...
    >
      ...
      <a href="{{ route(auth()->user()?->role === 'dosen' ? 'dashboard.dosen' : 'dashboard.mahasiswa') }}" class="lg:hidden">
    ...
    >
      ...
      >
        ...
        <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
          <img src="{{ Auth::user()->avatar_url }}" alt="User" class="h-full w-full object-cover" />
        </span>      
        ...
        >
          ...
          <form method="POST" action="{{ route('logout') }}">
            ...
            <button
              type="submit"
              class="group w-full text-left text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              <svg
